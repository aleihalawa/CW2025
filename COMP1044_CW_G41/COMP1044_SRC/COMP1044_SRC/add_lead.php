...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // $assigned_to = $_SESSION['user_id']; // removed

    if ($name && $email && $status) {
        $stmt = $conn->prepare("INSERT INTO leads (name, email, phone, company, status, follow_up_date, notes) VALUES (?, ?, ?, ?, ?, ?, ?)");
        $stmt->bind_param("sssssss", $name, $email, $phone, $company, $status, $follow_up, $notes);
        ...
        $error = "Name, Email, and Status are required.";
    }
}
?>
<!DOCTYPE html>
<html lang="en">
<head>
    <title>Add Lead - ABB Robotics CRM</title>
    <meta charset="UTF-8" />
...
<body>
  <div class="banner">
    <div class="welcome">Add Lead</div>
    <div class="logo">
