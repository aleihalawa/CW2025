...
if (isset($_GET['search'])) {
    ...
    $stmt = $conn->prepare("SELECT * FROM customers WHERE name LIKE ? OR email LIKE ? OR phone LIKE ?");
    $like = "%$search%";
...
<html lang="en">
<head>
    <title>View Customers - ABB Robotics CRM</title>
    <meta charset="UTF-8" />
...
<body>
  <div class="banner">
    <div class="welcome">Customer List</div>
    <div class="logo">
  ...
  <div class="container">
    ...
    <form method="GET">
        ...
        <a href="view_customers.php" class="btn-reset">Reset</a>
    </form>
    <table>
        <tr>
            <th>Name</th>
